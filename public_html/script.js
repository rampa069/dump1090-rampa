...
function fetchData(entry) {
    ...
    $.ajax({
	    ...
	    dataType: "jsonp",
	    error: function(data) {console.debug("Error getting data use dump1090-rampa....");},
	    jsonpCallback: 'dump1090',
...
function refreshSelected() {
	...
	if (selected && selected.squawk == 7500) { // Lets hope we never see this... Aircraft Hijacking
        ...
        html += '&nbsp;<a href="http://planefinder.net/data/flight/';
        html += selected.flight+'" target="_blank">[PlaneFinder]</a>';
	}
	html += '<td></tr>';
    ...
    for (var tablep in Planes) {
        ...
        if (!tableplane.reapable) {
            ...
            var tmp = {
                ...
                "flag": '<img src=/img/flags/' + tableplane.country_short.toLowerCase() + '.png' + ' title="' + tableplane.country + ' (' + tableplane.country_short + ')"  alt="' + tableplane.country + ' (' + tableplane.country_short + ')" />',
                ...
                "operator_logo": '<img src="/img/logo/' + tableplane.operator  + '.png'+ '" title="' + tableplane.operator + '"  alt="' + tableplane.operator + '" height="20" width="85" />',
                ...
                "silhouette": '<img src="/img/sil/' + tableplane.type + '.png" title="' + tableplane.type + '"  alt="' + tableplane.type + '" height="20" width="85" />',
